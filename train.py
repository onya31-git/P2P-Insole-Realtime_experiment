...
def main():
    ...
    data_pairs = [
        ...
        #  './data/20250517old_data/20241212test4/insoleSensor/20241212_173800_right.csv')
         ...
         # 新データ(test5)
         # s1
        ('./data/20250518test5/training_data/Skeleton/T005S001_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S001_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S001_Insole_r.csv'),
        # s2
        ('./data/20250518test5/training_data/Skeleton/T005S002_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S002_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S002_Insole_r.csv'),
        # s3
        ('./data/20250518test5/training_data/Skeleton/T005S003_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S003_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S003_Insole_r.csv'),
        # s4
        ('./data/20250518test5/training_data/Skeleton/T005S004_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S004_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S004_Insole_r.csv'),
        # s5
        ('./data/20250518test5/training_data/Skeleton/T005S005_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S005_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S005_Insole_r.csv'),
         # s6
        ('./data/20250518test5/training_data/Skeleton/T005S006_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S006_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S006_Insole_r.csv'),
         # s7
        ('./data/20250518test5/training_data/Skeleton/T005S007_skeleton.csv', 
         './data/20250518test5/training_data/Insole/T005S007_Insole_l.csv', 
         './data/20250518test5/training_data/Insole/T005S007_Insole_r.csv'),
    ]
